...
var url = 'http://tiy-515.herokuapp.com/collections/kishan-contact/';
var idToEdit;
...
var addEntryToView = function(entry){
  ...
  var entryHTML = "<li class='entry' id='" + entry._id + "'>";
      ...
      entryHTML +=      "<span><i class='options fa fa-pencil'></i></span>";
      entryHTML +=      "<span><i class='options fa fa-trash-o'></i></span>";
      entryHTML +=  "</div>";
      entryHTML += "</li>";
